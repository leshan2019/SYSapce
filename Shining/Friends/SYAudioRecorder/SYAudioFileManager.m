...
#import "SYAudioFileManager.h"
#import <AVFoundation/AVFoundation.h>

@implementation SYAudioFileManager
...
+(void)syAddAudio:(NSString *)fromPath toAudio:(NSString *)toPath outputPath:(NSString *)outputPath
{
    ...
    [session exportAsynchronouslyWithCompletionHandler:^{
        ...
        NSString *statusStr = [weakSelf syOutputStatus:status];
...
+(NSString *)syOutputStatus:(AVAssetExportSessionStatus)status
{
    /**
    ...
    NSLog(@"edit Audio state is %@", statusStr);
    return statusStr;
