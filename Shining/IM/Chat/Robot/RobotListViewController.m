...
- (void)viewDidLoad
{
    ...
    self.title = [NSBundle sy_localizedStringForKey:@"title.robotlist" value:@"robot list"];
...
//    [self.tableView addSubview:self.slimeView];
    ...
    [backButton setImage:[UIImage imageNamed_sy:@"back.png"] forState:UIControlStateNormal];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    IMBaseTableViewCell *cell = (IMBaseTableViewCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    
    // Configure the cell...
    if (cell == nil) {
        cell = [[IMBaseTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
    }
    
//    EMRobot *robot = [self.dataSource objectAtIndex:indexPath.row];
//    cell.imageView.image = [UIImage imageNamed_sy:@"chatListCellHead"];
