...
static IMDingMessageHelper *sharedInstance = nil;

@implementation IMDingMessageHelper

+ (instancetype)sharedHelper
{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[IMDingMessageHelper alloc] init];
    });
