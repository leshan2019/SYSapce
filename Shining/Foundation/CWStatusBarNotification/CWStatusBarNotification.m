...
{
    return CGRectMake(0, [self getStatusBarOffset] + 5, [self getStatusBarWidth], [self getNotificationLabelHeight]);
}
...
- (void)createNotificationLabelWithMessage:(NSString *)message
{
    ...
    self.notificationLabel.textAlignment = self.multiline ? NSTextAlignmentLeft : NSTextAlignmentCenter;
    ...
    [self.notificationLabel sy_addBlurWithFrame:self.notificationLabel.bounds];
}
