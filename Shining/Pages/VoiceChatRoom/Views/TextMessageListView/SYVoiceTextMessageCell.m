...
#define kGreetingMaxWidth 212
#define kMessageCellSingleLineHeight 28
#define kLevelViewWidth 38.f

@interface SYVoiceTextMessageCell ()

@end

@implementation SYVoiceTextMessageCell
...
+ (CGSize)cellSizeWithViewModel:(SYVoiceTextMessageViewModel *)viewModel
    ...
    switch (viewModel.messageType) {
        ...
        {
            return [SYVoiceGiftMessageCell cellSizeWithViewModel:viewModel
                                                           width:width];
        }
            break;
