...
@interface SYPersonHomepageInfoVC ()<UITextFieldDelegate, SYDatePickerViewDelegate, SYDistrictPickerViewDelegate,
UITextViewDelegate>
...
@implementation SYPersonHomepageInfoVC
