...
@interface RippleAnimationView () <CAAnimationDelegate>
...
- (CAAnimationGroup *)animationGroupAnimations:(NSArray *)array index:(int)index {
    ...
    animationGroup.beginTime = CACurrentMediaTime() + (double)(index * animationDuration) / (double)pulsingCount / 2;
...
- (CALayer *)pulsingLayer:(CGRect)rect animation:(CAAnimationGroup *)animationGroup {
    ...
    if (_animationType == AnimationTypeWithBackground) {
        pulsingLayer.backgroundColor = ColorWithAlpha(255, 255, 255, 0.1).CGColor;
        pulsingLayer.borderWidth = 0.5;
    } else {
        pulsingLayer.borderWidth = 1.f;
    }
    
    pulsingLayer.borderColor = ColorWithAlpha(255, 255, 255, 0.1).CGColor;
...
- (CAKeyframeAnimation *)backgroundColorAnimation {
    ...
    backgroundColorAnimation.values = @[(__bridge id)ColorWithAlpha(255, 255, 255, 0.12).CGColor,
                                        (__bridge id)ColorWithAlpha(255, 255, 255, 0.08).CGColor,
                                        (__bridge id)ColorWithAlpha(255, 255, 255, 0.04).CGColor,
                                        (__bridge id)ColorWithAlpha(255, 255, 255, 0.00).CGColor];
...
- (CAKeyframeAnimation *)borderColorAnimation {
    ...
    borderColorAnimation.values = @[(__bridge id)ColorWithAlpha(255, 255, 255, 0.1).CGColor,
                                    (__bridge id)ColorWithAlpha(255, 255, 255, 0.06).CGColor,
                                    (__bridge id)ColorWithAlpha(255, 255, 255, 0.02).CGColor,
                                    (__bridge id)ColorWithAlpha(255, 255, 255, 0.01).CGColor];
